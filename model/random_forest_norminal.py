...
X_encoded = pd.get_dummies(df[['Day_Nom', 'Month_Nom', 'Time_Nom']])

other_features = df[['Temperature', 'Humidity', 'Air_Pressure', 'Wind_Speed', 'Wind_Direction']]
...
sql_insert_query = "INSERT INTO prediction_tb (prediction_1_hour, prediction_3_hours, prediction_6_hours, prediction_12_hours, prediction_24_hours) VALUES (%s, %s, %s, %s, %s)"
