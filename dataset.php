...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary" style="background-color: #E7F6F2 !important;">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php"><strong>Dataset</strong></a>
...
function formatDate(date = new Date()) {
  ...
  $("#export").on("click", function() {
    ...
    var exportUrl = './api/value_Sensor/api_exportCSV.php';
    ...
    fetch(exportUrl)
        ...
        .then(blob => {
            ...
            a.href = url;
            a.download = 'exported_data.csv'; // Set the filename
  ...
  function loadTableData(startDate, endDate) {
    ...
    $.ajax({
      url: './api/value_Sensor/api_getDatasetTable.php',
      type: 'GET',
      data: {
